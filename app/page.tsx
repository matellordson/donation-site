...
export default function Home() {
  return (
    <div className="mx-auto mt-24 max-w-7xl px-3 lg:px-0">
      <div className="relative flex h-[430px] w-full items-end justify-start overflow-hidden rounded-xl bg-gray-700 shadow-sm">
        <Image
          src={"/banner.jpg"}
          ...
          priority
        />
        <div className="flex w-full flex-col items-start justify-center text-gray-200 lg:flex-row lg:items-end lg:justify-between">
